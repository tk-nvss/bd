...
const ValidationStep = dynamic(() => import("./ValidationStep"), { ssr: false });
const ReviewAndPaymentStep = dynamic(() => import("./ReviewAndPaymentStep"), { ssr: false });
  ...
  useEffect(() => {
    ...
    fetch("/api/auth/me", {
      ...
      .then((data) => {
        ...
        setUserType(data.user.userType || "user");
      });
  }, []);
